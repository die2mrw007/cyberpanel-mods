...
```
sh <(curl https://raw.githubusercontent.com/die2mrw007/cyberpanel-mods/main/script.sh || wget -O - https://raw.githubusercontent.com/die2mrw007/cyberpanel-mods/main/script.sh)
```
